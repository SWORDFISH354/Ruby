...
var commonModule = angular.module('common', ['ngRoute', 'ui.bootstrap','angular-loading-bar', 'ngAnimate', 'smart-table']);
...
commonModule.factory('viewModelHelper', function ($http, $q) {
    return window.GulfRuby.viewModelHelper($http, $q);
});
...
(function (cr) {
    var viewModelHelper = function ($http, $q) {
        ...
        var self = this;
        self.sucessAlert = false;
        self.sucessAlertMessage = 'Sucess';
        ...
        self.apiGet = function (uri, data, success, failure, always) {
            self.isLoading = true;
            self.modelIsValid = true;
            $http.get(window.GulfRuby.rootPath + uri, data)
        ...
        self.apiPost = function (uri, data, success, failure, always) {
            self.isLoading = true;
            self.modelIsValid = true;
            $http.post(window.GulfRuby.rootPath + uri, data)
                .then(function (result) {
                    success(result);
                    if (always != null)
                        always();
